...
final class FiscalYear
{
    ...
    {
        $start = self::parseTemplateMonthDay($generalSettings['financial_year_start'] ?? null, 1, 1);
        $end = self::parseTemplateMonthDay($generalSettings['financial_year_end'] ?? null, 12, 31);
