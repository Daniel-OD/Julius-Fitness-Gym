...
**Admin implicit:** `admin@julius.test` / `GymTest2026!` — schimbă parola imediat după primul login din panoul de administrare (Settings → Profile). Credențialele sunt salvate și în `storage/app/install-credentials.txt`.
