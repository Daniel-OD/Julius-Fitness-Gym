...
return [
    ...
    'client_portal' => [
        ...
        'open_qr' => 'Open full-screen QR',
        'qr_hint' => 'Show this code at the entrance to check in.',
        'checked_in_at' => 'Checked in :time',
        'checked_out_at' => 'Checked out :time',
        'still_present' => 'Still in the gym',
    ...
    'resources' => [
        ...
        'product_categories' => ['singular' => 'Product category', 'plural' => 'Product categories'],
        'products' => ['singular' => 'Product',       'plural' => 'Products'],
        'stock_movements' => ['singular' => 'Stock movement', 'plural' => 'Stock movements'],
        'sales' => ['singular' => 'Sale',          'plural' => 'Sales'],
        'exercises' => ['singular' => 'Exercise',      'plural' => 'Exercise library'],
        'workout_templates' => ['singular' => 'Workout template', 'plural' => 'Workout templates'],
        'member_workout_plans' => ['singular' => 'Member workout plan', 'plural' => 'Member workout plans'],
        'nutrition_plans' => ['singular' => 'Nutrition plan', 'plural' => 'Nutrition plans'],
        'staff_profiles' => ['singular' => 'Staff profile', 'plural' => 'Staff profiles'],
        'shifts' => ['singular' => 'Shift', 'plural' => 'Shifts'],
        'attendances' => ['singular' => 'Attendance', 'plural' => 'Attendance'],
        'leaves' => ['singular' => 'Leave request', 'plural' => 'Leave requests'],
        'payroll_periods' => ['singular' => 'Payroll period', 'plural' => 'Payroll'],
    ],
    ...
    'fitness' => [
        ...
        'food_log' => 'Food log',
        'no_workout_plan' => 'No active workout plan assigned yet.',
        'no_nutrition_plan' => 'No active nutrition plan assigned yet.',
        'no_food_logs' => 'Nothing logged for this day yet.',
        'day' => 'Day',
    ...
    'shop' => [
        ...
        'cancel_sales' => 'Cancel selected sales',
        'sales_cancelled' => 'Selected sales cancelled',
        'walk_in' => 'Walk-in customer',
        'cashier' => 'Cashier',
        'items' => 'Items',
        'member_shop_title' => 'Shop',
        'member_shop_subtitle' => 'Browse products available at the gym.',
        'purchase_history' => 'Purchase history',
        'purchase_history_subtitle' => 'Your previous shop orders.',
        ...
        'low_stock_description' => 'Products with stock below :threshold units',
        ...
        'errors' => [
            ...
            'invalid_products' => 'One or more products are invalid or inactive.',
            'insufficient_stock' => 'Insufficient stock for :product (available: :available).',
        ],
        'notes' => [
            'sale_deduction' => 'Sale completed',
            'sale_cancelled_restore' => 'Sale cancelled — stock restored',
        ],
    ],
    ...
    'settings' => [
        ...
        'import' => [
            ...
            'importing_now' => 'Importing…',
            'progress' => 'Importing… :percent%',
            'progress_rows' => 'Processed :current of :total members',
    ...
    'member' => [
        'auth' => [
            ...
            'verify_email_sent_to' => 'We sent a verification link to :email.',
            'verify_before_continue' => 'Please verify your email before continuing.',
    ...
    'hr' => [
        ...
        'actions' => [
            ...
            'open_qr' => 'Open attendance QR',
        ],
        'notifications' => [
            'payroll_generated' => 'Payroll period generated.',
            'payroll_approved' => 'Payroll period approved.',
        ...
        'checkin' => [
            ...
            'disabled' => 'Staff attendance is currently disabled.',
            'invalid_token' => 'Invalid staff QR code.',
            'success' => 'Welcome, :name!',
            'already_checked_in' => ':name is already checked in today.',
            'rate_limited' => 'Please wait :minutes minute(s) before scanning again.',
            'no_open_checkin' => 'No open check-in found for today.',
            'checkout' => 'Check out',
            'checkout_success' => 'Goodbye, :name!',
            'late_note' => 'Late by :minutes minute(s).',
        ],
        'attendance' => [
            'auto_absent' => 'Marked absent automatically (no check-in recorded).',
        ],
        'calendar' => [
