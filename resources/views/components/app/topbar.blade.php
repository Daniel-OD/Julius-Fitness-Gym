<header
    class="sticky top-0 z-20 flex h-16 items-center gap-3 border-b border-gray-200 bg-white/80 px-4 backdrop-blur sm:px-6 lg:px-8">
    ...
    <div class="relative hidden max-w-xs flex-1 sm:block">
        ...
        <input type="search" placeholder="Search members, invoices…"
            class="w-full rounded-lg border border-gray-200 bg-gray-50 py-2 pl-9 pr-3 text-sm text-gray-900 placeholder-gray-400 focus:border-brand-500 focus:bg-white focus:outline-none focus:ring-1 focus:ring-brand-500">
    </div>
    ...
    <div class="ml-auto flex items-center gap-1 sm:gap-2">
        ...
        <button type="button" data-theme-toggle title="Toggle theme"
            ...
            <svg class="hidden h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <circle cx="12" cy="12" r="4" /><path d="M12 2v2" /><path d="M12 20v2" /><path d="m4.93 4.93 1.41 1.41" />
                <path d="m17.66 17.66 1.41 1.41" /><path d="M2 12h2" /><path d="M20 12h2" />
                <path d="m6.34 17.66-1.41 1.41" /><path d="m19.07 4.93-1.41 1.41" />
            </svg>
            <svg class="block h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button type="button" title="Notifications"
            ...
            <span class="absolute right-1.5 top-1.5 h-2 w-2 rounded-full bg-brand-500 ring-2 ring-white"></span>
        </button>

        {{-- User dropdown --}}
        <div class="relative" data-dropdown>
            <button type="button" data-dropdown-trigger
                class="flex items-center gap-2 rounded-lg p-1 pr-2 hover:bg-gray-100">
                ...
                <span class="hidden text-left sm:block">
                    <span class="block text-sm font-medium leading-tight text-gray-900">
                        {{ auth()->user()->name ?? 'Admin' }}
                    </span>
                    <span class="block text-xs leading-tight text-gray-500">Administrator</span>
                </span>
            ...
            <div data-dropdown-menu
                class="absolute right-0 mt-2 hidden w-48 overflow-hidden rounded-lg border border-gray-200 bg-white py-1 shadow-lg">
                <a href="#"
