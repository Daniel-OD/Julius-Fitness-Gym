@php
    $serviceKeys = ['strength', 'groups', 'personal', 'recovery'];
    $serviceIcons = [
    ...
    $services = collect($serviceKeys)->map(fn (string $key): array => [
        'title' => __("public.services.items.{$key}.title"),
        'desc' => __("public.services.items.{$key}.desc"),
