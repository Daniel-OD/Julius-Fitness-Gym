...
<head>
    <x-layouts.partials.head-meta :title="__('app.member_portal.change_password_title', ['gym' => $gymName])" />
    ...
    <div class="jf-safe-x jf-safe-b mx-auto flex min-h-full max-w-sm flex-col justify-center px-4 py-10 sm:px-6">
        <div class="mb-8 text-center">
            ...
            <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
                {{ __('app.member_portal.change_password_intro') }}
            </p>
        </div>
            ...
            <form method="POST" action="{{ route('member.password.update') }}" class="space-y-5">
                ...
                <div>
                    <label for="current_password"
                        ...
                        {{ __('app.member_portal.current_password') }}
                    </label>
                ...
                <button type="submit"
                    ...
                    {{ __('app.member_portal.change_password_button') }}
                </button>
            </form>
        </div>
